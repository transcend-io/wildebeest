 ...
 * @see module:migrations/constants
 * @see module:migrations/controller
 * @see module:migrations/envs
 * @see module:migrations/routes
 * @see module:migrations/schemas
 * @see module:migrations/tests
 * @see module:migrations/typeDefs
 * @see module:migrations/views
 * @see module:migrationTypes
 */

// global
import createMap from '@bk/utils/createContainerMap';

// local
import * as migration from './migration';
import * as migrationLock from './migrationLock';

const MIGRATIONS = createMap.raw({
  migration,
  migrationLock,
});
